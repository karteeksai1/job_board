...
import { Briefcase, Bookmark, User, FileText, CheckCircle2, XCircle, AlertCircle, Clock, ChevronRight } from 'lucide-react';
                ...
                applications.map((app) => (
                  ...
                  >
                    <div className="flex gap-4">
                      ...
                      <div>
                        <Link href={`/jobs/${app.job.id}`} className="font-bold text-slate-900 dark:text-white hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                          {app.job.title}
                        </Link>
                ...
                bookmarks.map((bookmark) => (
                  ...
                  >
                    <div className="flex gap-4">
                      ...
                      <div>
                        <Link href={`/jobs/${bookmark.job.id}`} className="font-bold text-slate-900 dark:text-white hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                          {bookmark.job.title}
                        </Link>
