...
import { Eye, Users, FileText, CheckCircle2, XCircle, Clock, AlertCircle, Edit, Trash2, PlusCircle, LayoutDashboard, Briefcase, FileSignature, CheckSquare } from 'lucide-react';
                ...
                candidates.map((app) => (
                  ...
                  >
                    ...
                    <div className="flex flex-wrap items-center gap-4 shrink-0 w-full md:w-auto justify-between border-t md:border-t-0 pt-3 md:pt-0">
                      ...
                      {/* Status select pipeline controller */}
                      <div className="flex items-center gap-2">
