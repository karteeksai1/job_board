...
export const getLogoColor = (companyName) => {
...
const JobCard = ({ job, isBookmarked, onBookmarkToggle, userRole }) => {
  const {
    id,
    title,
    companyName,
    ...
    <div className="bg-white dark:bg-slate-800 rounded-xl p-5 border border-slate-100 dark:border-slate-700/80 shadow-sm hover-card flex flex-col gap-4 relative">
      <div className="flex items-start justify-between gap-4">
        <div className="flex items-start gap-4">
          ...
          <div>
            <Link to={`/jobs/${id}`} className="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
      ...
      {/* Footer info: Posted date, badges, view details link */}
